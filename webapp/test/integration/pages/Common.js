sap.ui.define([
	...
	return Opa5.extend("AgentPortal_Testing.AgentPortal_Testing.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["AgentPortal_Testing/AgentPortal_Testing/localService/mockserver"], function (mockserver) {
